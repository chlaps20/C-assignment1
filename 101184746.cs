// Roman Chlapak | 101184746 | Comp1202
using System;
...
namespace Application
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            string[] questions = { "What sport do EPL players play? ( Lacrosse : Soccer )", "Which one of these music artist is Canadian? ( Drake : Russ )", "Where is Cristiano Ronaldo from? ( Portgual : Argentina )", "Which spot on the podium did the Canadian Junior Hockey team get? ( Bronze : Gold )", "Who won the super bowl in 2019? ( Patriots : LA Rams )" };
            ...
            Console.WriteLine("Answer's are CASE SENSITIVE!!!");
            Console.WriteLine("------------------------------------------------------------------------------");
